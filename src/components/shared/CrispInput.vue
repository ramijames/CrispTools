  ...
  setup(props, { emit }) {
    ...
    const inputClasses = computed(() => {
      switch (props.inputType) {
        ...
        case "secondary":
          return "bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow text-slate-700 shadow-md shadow-black/5 ring-1 ring-slate-700/10";
        default:
